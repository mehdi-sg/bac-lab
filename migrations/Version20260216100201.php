 ...
 */
final class Version20260216100201 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profil ADD profile_picture VARCHAR(255) DEFAULT NULL, CHANGE date_naissance date_naissance DATE NOT NULL, CHANGE filiere_id filiere_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profil DROP profile_picture, CHANGE date_naissance date_naissance DATE DEFAULT NULL, CHANGE filiere_id filiere_id INT DEFAULT NULL');
