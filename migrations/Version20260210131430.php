 ...
 */
final class Version20260210131430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE membre_groupe (id INT AUTO_INCREMENT NOT NULL, role_membre VARCHAR(20) NOT NULL, date_joint DATETIME NOT NULL, utilisateur_id INT NOT NULL, groupe_id INT NOT NULL, INDEX IDX_9EB01998FB88E14F (utilisateur_id), INDEX IDX_9EB019987A45358C (groupe_id), UNIQUE INDEX uniq_membre_groupe (utilisateur_id, groupe_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT NOT NULL, type_message VARCHAR(10) NOT NULL, created_at DATETIME NOT NULL, parent_message_id INT DEFAULT NULL, expediteur_id INT NOT NULL, groupe_id INT NOT NULL, INDEX IDX_B6BD307F14399779 (parent_message_id), INDEX IDX_B6BD307F10335F61 (expediteur_id), INDEX IDX_B6BD307F7A45358C (groupe_id), INDEX idx_message_groupe_created (groupe_id, created_at), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
